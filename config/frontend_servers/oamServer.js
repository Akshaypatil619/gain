...
module.exports = function() {
    ...
    app.use(express.static(path.join(__dirname, '../oam')));
    app.get('/*', function(req, res) {
        res.sendFile(path.join(__dirname, '../oam/index.html'));
    });

    app.listen(apiConfig.oamPort, function() {
        console.log('oam panel started at port', apiConfig.oamPort)
    })
}
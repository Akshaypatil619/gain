...
module.exports = function (options) {
  ...
  return {
    ...
    send: function (model, done) {
      ...
      var message = {
        ...
        html: processEmailMessage(model.html , model.body || '', model.linkedData || null),
  ...
  function mapImageData (campaignImages) {
    ...
    function processEmailMessage( html , body , linkedData){
        for(let data in linkedData){
            body = body.replace(new RegExp('{{'+data+'}}','g'),linkedData[data]);
        }

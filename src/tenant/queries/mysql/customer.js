        ...
        switch (query_type) {
            case "get_send_ponints":
                return knex.select(data.columns)
                    ...
                    .leftJoin("master_point_type", "master_point_type.id", "=", "customers_point_transfer.point_type_id")
                    .leftJoin("customers", "customers.id", "=", "customers_point_transfer.transfer_to")
                    .where("customers_point_transfer.transfer_from ", data['transfer_from'])
                break;
            case "get_received_points":
                knex.select(data.columns)
                    .from("customers_point_transfer")
                    .leftJoin("master_point_type", "master_point_type.id", "=", "customers_point_transfer.point_type_id")
                    .leftJoin("customers", "customers.id", "=", "customers_point_transfer.transfer_from")

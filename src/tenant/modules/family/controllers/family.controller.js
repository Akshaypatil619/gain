...
module.exports = class FamilyController {
    ...
    async addFamily(req, res) {
        ...
        if (validation.passes() && !validation.fails()) {
            ...
            return_response['email_data'] = {logo_url: config['base_url'], email: formData.email, mobile: formData.phone, user_name: formData.first_name + " " + formData.last_name, language_code: "EN" };
            return_response['sms_data'] = {logo_url: config['base_url'], email: formData.email, mobile: formData.phone, user_name: formData.first_name + " " + formData.last_name, language_code: "EN" };

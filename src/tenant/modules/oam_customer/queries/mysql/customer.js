...
module.exports = class Customer {
    ...
    add_oam_customer(query_type, data) {
        switch (query_type) {
            case "get_oam_customer":
                return knex.select()
            ...
            case "update_extra_fields":
                return knex('customers')
                    ...
                    .where('id', data.oam_customer_id);
                break;
            case "insert_oam_customer_social_profile":
                return knex('oam_customer_social_profile')
                    .insert(data)
                break;
        }
    }
    edit_oam_customer(query_type, data) {
        switch (query_type) {
            case "get_oam_customer":
                knex('customers')
                    .where("email", data['email'])
            ...
            //     return knex('oam_customer_social_profile')
            //         .where('oam_customer_id', data['oam_customer_id'])
            //     break;
    ...
    get_oam_customers_list(query_type, data) {
        let obj;
        switch (query_type) {
            case "get_customers":
